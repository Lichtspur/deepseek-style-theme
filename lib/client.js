		...
		function DsttSection(props) {
			...
			return React.createElement('div', { className: 'dshome-dstt' },
				...
				React.createElement('p', null, isZh
					? '谷时段默认绿色；高峰时段（北京时间 9:00–12:00、14:00–18:00）自动切换为鲜红提示。峰谷模式可选谷色为蓝或绿，常态模式全天固定。'
					: 'Off-peak green; peak hours (Beijing 9:00–12:00, 14:00–18:00) switch to vivid red. Peak/valley modes pick the valley color (blue or green); always modes stay fixed all day.'),
