...
:root{
  ...
  --dshome-glass-sheen:.07;
  --dshome-glass-sheen-mid:.02;
  --dshome-glass-edge:rgba(255,255,255,.32);
  --dshome-glass-edge-low:rgba(255,255,255,.08);
  --dshome-glass-ring:rgba(255,255,255,.08);
  --dshome-glass-shadow:0 12px 40px rgba(0,0,0,.12);
  --dshome-glass-spec:0;
}
body[data-dshome-dark]{
  --dshome-glass-sheen:.10;
  --dshome-glass-sheen-mid:.03;
  --dshome-glass-edge:rgba(255,255,255,.20);
  --dshome-glass-edge-low:rgba(255,255,255,.05);
  --dshome-glass-ring:rgba(255,255,255,.10);
...
`;
		...
		*/
		...
		function dshomeFluidParams() {
			...
			return { ...SITE_FLUID_PARAMS, color1: pick[0], color2: pick[1], color3: pick[2] };
		}
		...
		*/
		/**
		* Specular spot surfaces: the composer card and the message bubbles. The
		* transcript pane and the centre column are deliberately NOT spots — a
		* cursor-following highlight across that much empty area reads as a large
		* white patch sliding over the background.
		*/
		const SPOT_SURFACES = '.gdEzaW_bubble,.uV2eYG_card,.dshome-sa,.dshome-file-menu,.hHd-Xa_root,[data-composer-card]';
		...
		*/
		function startAmbient() {
			...
			const stopRipples = attachFluidInteractions({ main: fluid, mainCanvas: canvas });
